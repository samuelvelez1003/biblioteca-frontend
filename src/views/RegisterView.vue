  ...
  <div class="auth-page">
    <div class="auth-card wide">
      ...
      <select v-model="form.role">
        ...
        <option value="bibliotecario">Bibliotecario: aprobar prestamos y ver libros prestados</option>
        <option value="admin">Admin: generar reportes PDF</option>
      </select>
      ...
      <div class="demo-box">
        <strong>Bibliotecario de prueba</strong>
        <span>Correo: bibliotecario@biblioteca.com</span>
        <span>Contraseña: Biblio12345</span>
      </div>
